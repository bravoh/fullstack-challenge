      ...
      <b-list-group v-for="user in apiResponse.users" v-bind:key="user.id">
        <b-list-group-item :to="`/user/${user.id}`">
          ...
          <div v-if="user.weather">
            ...
            <div v-if="payloadAsObj(user.weather.payload).cloudCover">
              <svg
              ...
              Cloudy Cover: {{ payloadAsObj(user.weather.payload).cloudCover }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).humidity">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Humidity: {{ payloadAsObj(user.weather.payload).humidity }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).dewPoint">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Dew Level: {{ payloadAsObj(user.weather.payload).dewPoint }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).windSpeed">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Wind Speed: {{ payloadAsObj(user.weather.payload).windSpeed }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).rainIntensity">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Rain: {{ payloadAsObj(user.weather.payload).rainIntensity }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).snowIntensity">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Snowy: {{ payloadAsObj(user.weather.payload).snowIntensity }}
            </div>

            <div v-if="payloadAsObj(user.weather.payload).temperature">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Temperature: {{ payloadAsObj(user.weather.payload).temperature }}
            </div>
          </div>
        </b-list-group-item>
      </b-list-group>
